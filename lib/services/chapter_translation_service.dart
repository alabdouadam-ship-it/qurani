...
class ChapterTranslationService {
  ...
  static final Map<String, Map<String, String>> _dictionary = {
    ...
    "Revelation": {"ar": "بدء الوحي", "fr": "La Révélation"},
    "Belief": {"ar": "الإيمان", "fr": "La Foi"},
    "The Book of Faith": {"ar": "كتاب الإيمان", "fr": "Le Livre de la Foi"},
    "Knowledge": {"ar": "العلم", "fr": "Le Savoir"},
    "Ablutions (Wudu')": {"ar": "الوضوء", "fr": "Les Ablutions (Wudu')"},
    "Bathing (Ghusl)": {"ar": "الغسل", "fr": "Le Bain (Ghusl)"},
    "Menstrual Periods": {"ar": "الحيض", "fr": "Les Menstrues"},
    "Rubbing hands and feet with dust (Tayammum)": {
      "ar": "التييم",
      "fr": "Le Tayammum"
    },
    "Prayers (Salat)": {"ar": "الصلاة", "fr": "La Prière (Salat)"},
    "The Book of Prayers": {"ar": "كتاب الصلاة", "fr": "Le Livre de la Prière"},
    "Times of the Prayers": {
      "ar": "مواقيت الأذان",
      "fr": "Les horaires d'aladhan"
    },
    "Call to Prayers (Adhaan)": {
      "ar": "الأذان",
      "fr": "L'Appel à la Prière (Adhan)"
    },
    "Friday Prayer": {"ar": "الجمعة", "fr": "La Prière du Vendredi"},
    "Fear Prayer": {"ar": "صلاة الخوف", "fr": "La Prière de la Peur"},
    "The Two Festivals (Eids)": {"ar": "العيدين", "fr": "Les Deux Fêtes (Aïd)"},
    "Witr Prayer": {"ar": "الوتر", "fr": "La Prière du Witr"},
    "Invoking Allah for Rain (Istisqaa)": {
      "ar": "الاستسقاء",
      "fr": "L'Invocation pour la Pluie"
    },
    "Eclipses": {"ar": "الكسوف", "fr": "Les Éclipses"},
    ...
    "Funerals (Al-Janaa'iz)": {"ar": "الجنائز", "fr": "Les Funérailles"},
    "Obligatory Charity Tax (Zakat)": {"ar": "الزكاة", "fr": "La Zakât"},
    "The Book of Zakat": {"ar": "كتاب الزكاة", "fr": "Le Livre de la Zakât"},
    "Hajj (Pilgrimage)": {"ar": "الحج", "fr": "Le Pèlerinage (Hajj)"},
    "The Book of Pilgrimage": {
      "ar": "كتاب الحج",
      "fr": "Le Livre du Pèlerinage"
    },
    "`Umrah (Minor pilgrimage)": {"ar": "العمرة", "fr": "La Omra"},
    "Fasting": {"ar": "الصوم", "fr": "Le Jeûne"},
    "The Book of Fasting": {"ar": "كتاب الصيام", "fr": "Le Livre du Jeûne"},
    "Before Day of Judgment": {"ar": "أشراط الساعة", "fr": "Signes de l'Heure"},
    "Sales and Trade": {"ar": "البيوع", "fr": "Les Ventes"},
    "Hiring": {"ar": "الإجارة", "fr": "La Location"},
    ...
    "Agriculture": {"ar": "المزارعة", "fr": "L'Agriculture"},
    ...
    "Oppressions": {"ar": "المظالم", "fr": "Les Injustices (Mazalim)"},
    "Partnership": {"ar": "الشركة", "fr": "Le Partenariat"},
    "Mortgaging": {"ar": "الرهن", "fr": "L'Hypothèque"},
    "Manumission of Slaves": {"ar": "العتق", "fr": "L'Affranchissement"},
    "Gifts": {"ar": "الهبة", "fr": "Les Dons"},
    "Witnesses": {"ar": "الشهادات", "fr": "Les Témoignages"},
    "Peacemaking": {"ar": "الصلح", "fr": "La Réconciliation"},
    "Conditions": {"ar": "الشروط", "fr": "Les Conditions"},
    ...
    "The Book of Jihad": {"ar": "كتاب الجهاد", "fr": "Le Livre du Jihad"},
    ...
    "Prophets": {"ar": "الأنبياء", "fr": "Les Prophètes"},
    ...
    "Wedlock, Marriage (Nikaah)": {"ar": "النكاح", "fr": "Le Mariage (Nikah)"},
    "The Book of Marriage": {"ar": "كتاب النكاح", "fr": "Le Livre du Mariage"},
    "Divorce": {"ar": "الطلاق", "fr": "Le Divorce"},
    "The Book of Divorce": {"ar": "كتاب الطلاق", "fr": "Le Livre du Divorce"},
    "Food, Meals": {"ar": "الأطعمة", "fr": "La Nourriture"},
    ...
    "Drinks": {"ar": "الأشربة", "fr": "Les Boissons"},
    "Patients": {"ar": "المرضى", "fr": "Les Malades"},
    "Medicine": {"ar": "الطب", "fr": "La Médecine"},
    "Dress": {"ar": "اللباس", "fr": "L'Habillement"},
    "Good Manners and Form (Al-Adab)": {
      "ar": "الأدب",
      "fr": "Les Bonnes Manières"
    },
    "Asking Permission": {"ar": "الاستئذان", "fr": "La permission"},
    "Invocations": {"ar": "الدعوات", "fr": "Les Invocations"},
    "Divine Will (Al-Qadar)": {"ar": "القدر", "fr": "Le Destin (Qadar)"},
    "The Book of Destiny": {"ar": "كتاب القدر", "fr": "Le Livre du Destin"},
    "Oaths and Vows": {"ar": "الأيمان والنذور", "fr": "Les Serments et Vœux"},
    ...
    "Blood Money (Ad-Diyat)": {"ar": "الديات", "fr": "Le Prix du Sang (Diyat)"},
    "Apostates": {"ar": "استتابة المرتد", "fr": "L'Apostalsie"},
    "(Statements made under) Coercion": {
      "ar": "الإكراه",
      "fr": "La Contrainte"
    },
    "Tricks": {"ar": "الحِيَل", "fr": "Les Ruses (Hiyam)"},
    ...
    "Judgments (Ahkaam)": {"ar": "الأحكام", "fr": "Les Jugements"},
    "Wishes": {"ar": "التمني", "fr": "Les Souhaits"},
    ...
    "Virtues of Madinah": {"ar": "فضائل المدينة", "fr": "Les vertus de Médine"},
    ...
    "Sales in which a Price is paid for Goods to be Delivered Later (As-Salam)":
        {"ar": "السلم", "fr": "La vente Salam"},
    "Shuf'a": {"ar": "الشفعة", "fr": "La préemption (Shuf'a)"},
    "Kafalah": {"ar": "الكفالة", "fr": "Le cautionnement"},
    "Khusoomaat": {"ar": "الخصومات", "fr": "Les litiges"},
    "Makaatib": {"ar": "المكاتب", "fr": "Le contrat d'écriture (Mukataba)"},
    ...
    "Supporting the Family": {"ar": "النفقات", "fr": "Les dépenses (Nafaqa)"},
    "To make the Heart Tender (Ar-Riqaq)": {
      "ar": "الرقاق",
      "fr": "L'attendrissement des cœurs"
    },
    "Laws of Inheritance (Al-Faraa'id)": {
      // JSON Variant spelling
      "ar": "الفرائض",
      "fr": "L'Héritage (Fara'id)"
    },
    ...
    "Prayer (Kitab Al-Salat)": {"ar": "كتاب الصلاة", "fr": "Prière (Salat)"},
    "Zakat (Kitab Al-Zakat)": {"ar": "كتاب الزكاة", "fr": "Zakât"},
    "The Rites of Hajj (Kitab Al-Manasik Wa'l-Hajj)": {
      "ar": "كتاب المناسك",
      "fr": "Rites du Hajj"
    },
    "Marriage (Kitab Al-Nikah)": {"ar": "كتاب النكاح", "fr": "Mariage"},
    "Divorce (Kitab Al-Talaq)": {"ar": "كتاب الطلاق", "fr": "Divorce"},
    "Fasting (Kitab Al-Siyam)": {"ar": "كتاب الصيام", "fr": "Jeûne"},
    "Jihad (Kitab Al-Jihad)": {"ar": "كتاب الجهاد", "fr": "Jihad"},
    ...
    "Introduction": {"ar": "المقدمة", "fr": "Introduction"},
    ...
    "The Book of Gifts": {"ar": "كتاب الهبات", "fr": "Le Livre des Dons"},
    "The Book of Vows": {"ar": "كتاب النذر", "fr": "Le Livre des Vœux"},
    "The Book of Oaths": {"ar": "كتاب الأيمان", "fr": "Le Livre des Serments"},
    ...
    "The Book of Drinks": {"ar": "كتاب الأشربة", "fr": "Le Livre des Boissons"},
    ...
    "The Book of Poetry": {"ar": "كتاب الشعر", "fr": "Le Livre de la Poésie"},
    "The Book of Dreams": {"ar": "كتاب الرؤيا", "fr": "Le Livre des Rêves"},
    "The Book of Virtues": {"ar": "كتاب الفضائل", "fr": "Le Livre des Vertus"},
    "The Book of the Merits of the Companions": {
      "ar": "كتاب فضائل الصحابة",
      "fr": "Les Mérites des Compagnons"
    },
    "The Book of Virtue, Enjoining Good Manners, and Joining of the Ties of Kinship":
        {"ar": "كتاب البر والصلة والآداب", "fr": "Vertu et Liens de Parenté"},
    "The Book of Knowledge": {"ar": "كتاب العلم", "fr": "Le Livre du Savoir"},
    ...
    "Prayer (Kitab Al-Salat): Detailed Rules of Law about the Prayer during Journey":
        {"ar": "كتاب صلاة السفر", "fr": "Prière du Voyageur"},
    ...
    "Knowledge (Kitab Al-Ilm)": {"ar": "كتاب العلم", "fr": "Le Savoir"},
    "Drinks (Kitab Al-Ashribah)": {"ar": "كتاب الأشربة", "fr": "Les Boissons"},
    "Foods (Kitab Al-At'imah)": {"ar": "كتاب الأطعمة", "fr": "Les Aliments"},
    "Medicine (Kitab Al-Tibb)": {"ar": "كتاب الطب", "fr": "La Médecine"},
    ...
    "Hot Baths (Kitab Al-Hammam)": {"ar": "كتاب الحمام", "fr": "Les Bains"},
    "Sacrifice (Kitab Al-Dahaya)": {
      "ar": "كتاب الضحايا",
      "fr": "Les Sacrifices"
    },
    "Game (Kitab Al-Said)": {"ar": "كتاب الصيد", "fr": "Le Gibier"},
    "Wills (Kitab Al-Wasaya)": {"ar": "كتاب الوصايا", "fr": "Les Testaments"},
    ...
    //   "fr": "Transactions Commerciales"
    // },
    "Wages (Kitab Al-Ijarah)": {"ar": "كتاب الإجارة", "fr": "Les Salaires"},
    "Clothing (Kitab Al-Libas)": {"ar": "كتاب اللباس", "fr": "Les Vêtements"},
    "Combing the Hair (Kitab Al-Tarajjul)": {
      "ar": "كتاب الترجل",
      "fr": "Coiffure"
    },
    "Signet-Rings (Kitab Al-Khatam)": {"ar": "كتاب الخاتم", "fr": "Les Bagues"},
    ...
    "Battles (Kitab Al-Malahim)": {"ar": "كتاب الملاحم", "fr": "Les Batailles"},
    ...
    "The Book on the Day of Friday": {
      "ar": "كتاب الجمعة",
      "fr": "Le Livre du Vendredi"
    },
    "The Book on the Two Eids": {
      "ar": "كتاب العيدين",
      "fr": "Le Livre des Deux Aïds"
    },
    ...
    "The Book on Divorce and Li'an": {
      "ar": "كتاب الطلاق واللعان",
      "fr": "Le Livre du Divorce et du Li'an"
    },
    "The Book on Business": {"ar": "كتاب البيوع", "fr": "Le Livre des Ventes"},
    "The Chapters On Judgements From The Messenger of Allah": {
      "ar": "أبواب الأحكام",
      "fr": "Chapitres sur les Jugements"
    },
    "The Book on Blood Money": {
      "ar": "كتاب الديات",
      "fr": "Le Livre du Prix du Sang"
    },
    ...
    "The Book on Vows and Oaths": {
      "ar": "كتاب النذور والأيمان",
      "fr": "Le Livre des Vœux et Serments"
    },
    "The Book on Military Expeditions": {
      "ar": "كتاب السير",
      "fr": "Le Livre des Expéditions"
    },
    "The Book on Virtues of Jihad": {
      "ar": "كتاب فضائل الجهاد",
      "fr": "Le Livre des Mérites du Jihad"
    },
    "The Book on Jihad": {"ar": "كتاب الجهاد", "fr": "Le Livre du Jihad"},
    "The Book on Clothing": {
      "ar": "كتاب اللباس",
      "fr": "Le Livre des Vêtements"
    },
    "The Book on Food": {
      "ar": "كتاب الأطعمة",
      "fr": "Le Livre de la Nourriture"
    },
    "The Book on Drinks": {"ar": "كتاب الأشربة", "fr": "Le Livre des Boissons"},
    "Chapters on Righteousness And Maintaining Good Relations With Relatives": {
      "ar": "أبواب البر والصلة",
      "fr": "Chapitres sur la Piété et les Liens de Parenté"
    },
    "Chapters on Medicine": {
      "ar": "أبواب الطب",
      "fr": "Chapitres sur la Médecine"
    },
    "Chapters On Inheritance": {
      "ar": "أبواب الفرائض",
      "fr": "Chapitres sur l'Héritage"
    },
    "Chapters On Wasaya (Wills and Testament)": {
      "ar": "أبواب الوصايا",
      "fr": "Chapitres sur les Testaments"
    },
    "Chapters On Wala' And Gifts": {
      "ar": "أبواب الولاء والهبة",
      "fr": "Chapitres sur l'Alliance et les Dons"
    },
    "Chapters On Al-Qadar": {
      "ar": "أبواب القدر",
      "fr": "Chapitres sur le Destin"
    },
    "Chapters On Al-Fitan": {
      "ar": "أبواب الفتن",
      "fr": "Chapitres sur les Troubles"
    },
    "Chapters On Dreams": {
      "ar": "أبواب الرؤيا",
      "fr": "Chapitres sur les Rêves"
    },
    "Chapters On Witnesses": {
      "ar": "أبواب الشهادات",
      "fr": "Chapitres sur les Témoignages"
    },
    "Chapters On Zuhd": {
      "ar": "أبواب الزهد",
      "fr": "Chapitres sur l'Ascétisme"
    },
    "Chapters on the description of the Day of Judgement, Ar-Riqaq, and Al-Wara'":
        {"ar": "أبواب صفة القيامة", "fr": "Description du Jugement Dernier"},
    "The Book on the Description of Hellfire": {
      "ar": "أبواب صفة جهنم",
      "fr": "Description de l'Enfer"
    },
    "The Book on Faith": {"ar": "أبواب الإيمان", "fr": "Le Livre de la Foi"},
    "Chapters on Knowledge": {
      "ar": "أبواب العلم",
      "fr": "Chapitres sur le Savoir"
    },
    "Chapters on Seeking Permission": {
      "ar": "أبواب الاستئذان",
      "fr": "Chapitres sur la Permission"
    },
    "Chapters on Manners": {
      "ar": "أبواب الأدب",
      "fr": "Chapitres sur les Bonnes Manières"
    },
    "Chapters on Parables": {
      "ar": "أبواب الأمثال",
      "fr": "Chapitres sur les Paraboles"
    },
    "Chapters on The Virtues of the Qur'an": {
      "ar": "أبواب فضائل القرآن",
      "fr": "Chapitres sur les Mérites du Coran"
    },
    "Chapters on Recitation": {
      "ar": "أبواب القراءات",
      "fr": "Chapitres sur la Récitation"
    },
    "Chapters on Tafsir": {
      "ar": "أبواب التفسير",
      "fr": "Chapitres sur l'Exégèse"
    },
    "Chapters on Supplication": {
      "ar": "أبواب الدعوات",
      "fr": "Chapitres sur les Invocations"
    },
    "Chapters on Virtues": {
      "ar": "أبواب المناقب",
      "fr": "Chapitres sur les Vertus"
    },

    // --- Sunan An-Nasai ---
    "The Book of Water": {"ar": "كتاب المياه", "fr": "Le Livre de l'Eau"},
    "The Book of Menstruation and Istihadah": {
      "ar": "كتاب الحيض والاستحاضة",
      "fr": "Menstrues et Istihadah"
    },
    "The Book of Ghusl and Tayammum": {
      "ar": "كتاب الغسل والتيمم",
      "fr": "Ghusl et Tayammum"
    },
    "The Book of Salah": {"ar": "كتاب الصلاة", "fr": "Le Livre de la Prière"},
    "The Book of the Times (of Prayer)": {
      "ar": "كتاب المواقيت",
      "fr": "Le Livre des Horaires"
    },
    "The Book of the Adhan (The Call to Prayer)": {
      "ar": "كتاب الأذان",
      "fr": "Le Livre de l'Adhan"
    },
    ...
    "The Book of the Qiblah": {
      "ar": "كتاب القبلة",
      "fr": "Le Livre de la Qibla"
    },
    "The Book of Leading the Prayer (Al-Imamah)": {
      "ar": "كتاب الإمامة",
      "fr": "Le Livre de l'Imamat"
    },
    "The Book of the Commencement of the Prayer": {
      "ar": "كتاب الافتتاح",
      "fr": "Commencement de la Prière"
    },
    "The Book of The At-Tatbiq (Clasping One's Hands Together)": {
      "ar": "كتاب التطبيق",
      "fr": "Le Livre du Tatbiq"
    },
    "The Book of Forgetfulness (In Prayer)": {
      "ar": "كتاب السهو",
      "fr": "Oubli dans la Prière"
    },
    ...
    "The Book of Shortening the Prayer When Traveling": {
      "ar": "كتاب تقصير الصلاة في السفر",
      "fr": "Raccourcissement de la Prière"
    },
    "The Book of Eclipses": {
      "ar": "كتاب الكسوف",
      "fr": "Le Livre des Éclipses"
    },
    ...
    "The Book of Qiyam Al-Lail (The Night Prayer) and Voluntary Prayers During the Day":
        {
      "ar": "كتاب قيام الليل وتطوع النهار",
      "fr": "Prière de Nuit et Surérogatoires"
    },
    ...
    "The Book of Agriculture": {
      "ar": "كتاب المزارعة",
      "fr": "Le Livre de l'Agriculture"
    },
    "The Book of the Kind Treatment of Women": {
      "ar": "كتاب عشرة النساء",
      "fr": "Traitement des Femmes"
    },
    "The Book of Fighting [The Prohibition of Bloodshed]": {
      "ar": "كتاب تحريم الدم",
      "fr": "Interdiction du Sang"
    },
    "The Book of Distribution of Al-Fay'": {
      "ar": "كتاب قسم الفيء",
      "fr": "Distribution du Fay'"
    },
    "The Book of al-Bay'ah": {
      "ar": "كتاب البيعة",
      "fr": "Le Livre de l'Allégeance"
    },
    "The Book of al-'Aqiqah": {
      "ar": "كتاب العقيقة",
      "fr": "Le Livre de la Aqiqah"
    },
    "The Book of al-Fara' and al-'Atirah": {
      "ar": "كتاب الفرع والعتيرة",
      "fr": "Fara' et Atirah"
    },
    "The Book of Hunting and Slaughtering": {
      "ar": "كتاب الصيد والذبائح",
      "fr": "Chasse et Abattage"
    },
    ...
    "The Book of Oaths (qasamah), Retaliation and Blood Money": {
      "ar": "كتاب القسامة",
      "fr": "Serments et Talion"
    },
    "The Book of Cutting off the Hand of the Thief": {
      "ar": "كتاب قطع السارق",
      "fr": "Couper la Main du Voleur"
    },
    "The Book Of Faith and its Signs": {
      "ar": "كتاب الإيمان وشرائعه",
      "fr": "Foi et ses Signes"
    },
    "The Book of Adornment": {
      "ar": "كتاب الزينة",
      "fr": "Le Livre de la Parure"
    },
    "The Book of the Etiquette of Judges": {
      "ar": "كتاب آداب القضاة",
      "fr": "Étiquette des Juges"
    },
    "The Book of Seeking Refuge with Allah": {
      "ar": "كتاب الاستعاذة",
      "fr": "Refuge auprès d'Allah"
    },

    // --- Sunan Ibn Majah ---
    "The Book of the Sunnah": {"ar": "المقدمة", "fr": "Le Livre de la Sunna"},
    "The Book of Purification and its Sunnah": {
      "ar": "كتاب الطهارة وسننها",
      "fr": "Purification et Sunna"
    },
    ...
    "The Book of the Adhan and the Sunnah Regarding It": {
      "ar": "كتاب الأذان والسنة فيها",
      "fr": "L'Adhan et sa Sunna"
    },
    "The Book On The Mosques And The Congregations": {
      "ar": "كتاب المساجد والجماعات",
      "fr": "Mosquées et Congrégations"
    },
    "Establishing the Prayer and the Sunnah Regarding Them": {
      "ar": "كتاب إقامة الصلاة والسنة فيها",
      "fr": "Établissement de la Prière"
    },
    "Chapters Regarding Funerals": {
      "ar": "كتاب الجنائز",
      "fr": "Chapitres sur les Funérailles"
    },
    "The Chapters Regarding Zakat": {
      "ar": "كتاب الزكاة",
      "fr": "Chapitres sur la Zakat"
    },
    "The Chapters on Marriage": {
      "ar": "كتاب النكاح",
      "fr": "Chapitres sur le Mariage"
    },
    "The Chapters on Divorce": {
      "ar": "كتاب الطلاق",
      "fr": "Chapitres sur le Divorce"
    },
    "The Chapters on Expiation": {
      "ar": "كتاب الكفارات",
      "fr": "Chapitres sur l'Expiation"
    },
    "The Chapters on Business Transactions": {
      "ar": "كتاب التجارات",
      "fr": "Chapitres sur le Commerce"
    },
    ...
    "The Chapters on Gifts": {
      "ar": "كتاب الهبات",
      "fr": "Chapitres sur les Dons"
    },
    "The Chapters on Charity": {
      "ar": "كتاب الصدقات",
      "fr": "Chapitres sur la Charité"
    },
    "The Chapters on Pawning": {
      "ar": "كتاب الرهون",
      "fr": "Chapitres sur le Gage"
    },
    "The Chapters on Pre-emption": {
      "ar": "كتاب الشفعة",
      "fr": "Chapitres sur la Préemption"
    },
    "The Chapters on Lost Property": {
      "ar": "كتاب اللقطة",
      "fr": "Chapitres sur les Objets Trouvés"
    },
    "The Chapters on Manumission (of Slaves)": {
      "ar": "كتاب العتق",
      "fr": "Chapitres sur l'Affranchissement"
    },
    "The Chapters on Legal Punishments": {
      "ar": "كتاب الحدود",
      "fr": "Chapitres sur les Peines"
    },
    "The Chapters on Blood Money": {
      "ar": "كتاب الديات",
      "fr": "Chapitres sur le Prix du Sang"
    },
    ...
    "The Chapters on Jihad": {
      "ar": "كتاب الجهاد",
      "fr": "Chapitres sur le Jihad"
    },
    "Chapters on Hajj Rituals": {"ar": "كتاب المناسك", "fr": "Rites du Hajj"},
    "Chapters on Sacrifices": {
      "ar": "كتاب الأضاحي",
      "fr": "Chapitres sur les Sacrifices"
    },
    "Chapters on Slaughtering": {
      "ar": "كتاب الذبائح",
      "fr": "Chapitres sur l'Abattage"
    },
    "Chapters on Hunting": {
      "ar": "كتاب الصيد",
      "fr": "Chapitres sur la Chasse"
    },
    "Chapters on Food": {
      "ar": "كتاب الأطعمة",
      "fr": "Chapitres sur la Nourriture"
    },
    "Chapters on Drinks": {
      "ar": "كتاب الأشربة",
      "fr": "Chapitres sur les Boissons"
    },
    // "Chapters on Medicine": { "ar": "كتاب الطب", "fr": "Chapitres sur la Médecine" },
    "Chapters on Dress": {
      "ar": "كتاب اللباس",
      "fr": "Chapitres sur les Vêtements"
    },
    ...
    "The Description of the Prophet, may Allah Bless Him and Grant Him Peace": {
      "ar": "صفة النبي صلى الله عليه وسلم",
      "fr": "Description du Prophète"
    },
    ...
    "Chapters on the description of Paradise": {
      "ar": "أبواب صفة الجنة",
      "fr": "Description du Paradis"
    },
    "Forty Hadith of Shah Waliullah Dehlawi": {
      "ar": "أربعون حديث للشاه ولي الله الدهلوي",
      "fr": "Les Quarante Hadiths de Shah Waliullah Dehlawi"
    },
    "Forty Hadith of an-Nawawi": {
      "ar": "الأربعون النووية",
      "fr": "Les Quarante Hadiths de l'Imam Nawawi"
    },
    "Forty Hadith Qudsi": {
      "ar": "الأحاديث القدسية",
      "fr": "Les Quarante Hadiths Qudsi"
    },
    "The Names of the Prophet, may Allah Bless Him and Grant Him Peace": {
      "ar": "أسماء النبي صلى الله عليه وسلم",
      "fr": "Noms du Prophète"
    },
