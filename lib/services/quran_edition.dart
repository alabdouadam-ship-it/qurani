...
class QuranEditions {
  ...
  static const QuranEdition simple = QuranEdition(
    ...
    jsonAsset: 'assets/data/quran-simple.json',
    isRtl: true,
    l10nKey: 'simple',
  );
  ...
  static const QuranEdition uthmani = QuranEdition(
    ...
    jsonAsset: 'assets/data/quran-uthmani.json',
    isRtl: true,
    l10nKey: 'uthmani',
  );
  ...
  static const QuranEdition tajweed = QuranEdition(
    ...
    jsonAsset: 'assets/data/quran-tajweed.json',
    isRtl: true,
  ...
  static const QuranEdition english = QuranEdition(
    ...
    jsonAsset: 'assets/data/quran-english.json',
    isRtl: false,
    languageCode: 'en',
  ...
  static const QuranEdition french = QuranEdition(
    ...
    jsonAsset: 'assets/data/quran-french.json',
    isRtl: false,
    languageCode: 'fr',
  ...
  static const QuranEdition turkish = QuranEdition(
    ...
    jsonAsset: 'https://qurani.info/data/editions/tr.vakfi.json',
    isRtl: false,
    languageCode: 'tr',
  ...
  static const QuranEdition german = QuranEdition(
    ...
    jsonAsset: 'https://qurani.info/data/editions/de.bubenheim.json',
    isRtl: false,
    languageCode: 'de',
  ...
  static const QuranEdition tafsirMuyassar = QuranEdition(
    ...
    jsonAsset: 'https://qurani.info/data/editions/ar.muyassar.json',
    isRtl: true,
  ...
  static const QuranEdition tafsirJalalayn = QuranEdition(
    ...
    jsonAsset: 'https://qurani.info/data/editions/ar.jalalayn.json',
    isRtl: true,
    audioReciterKey: null,
  ...
  static const QuranEdition tafsirQurtubi = QuranEdition(
    ...
    jsonAsset: 'https://qurani.info/data/editions/ar.qurtubi.json',
    isRtl: true,
    audioReciterKey: null,
  ...
  static const QuranEdition tafsirMiqbas = QuranEdition(
    ...
    jsonAsset: 'https://qurani.info/data/editions/ar.miqbas.json',
    isRtl: true,
    audioReciterKey: null,
  ...
  static const QuranEdition tafsirWaseet = QuranEdition(
    ...
    jsonAsset: 'https://qurani.info/data/editions/ar.waseet.json',
    isRtl: true,
    audioReciterKey: null,
  ...
  static const QuranEdition tafsirBaghawi = QuranEdition(
    ...
    jsonAsset: 'https://qurani.info/data/editions/ar.baghawi.json',
    isRtl: true,
    audioReciterKey: null,
